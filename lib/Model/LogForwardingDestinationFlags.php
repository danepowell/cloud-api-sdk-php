...
/**
 * LogForwardingDestinationFlags Class Doc Comment
 *
 * @category Class
 ...
 */
class LogForwardingDestinationFlags implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LogForwardingDestinationFlags';
    ...
    protected static $setters = [
        'enabled' => 'setEnabled',
        'certificate_expiring' => 'setCertificateExpiring'
    ];
    ...
    protected static $getters = [
        'enabled' => 'getEnabled',
        'certificate_expiring' => 'getCertificateExpiring'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('certificate_expiring', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Destination enabled status.
     *
     * @return self
     */
    ...
    /**
     * Gets certificate_expiring
     *
     * @return bool|null
     */
    public function getCertificateExpiring()
    {
        return $this->container['certificate_expiring'];
    }

    /**
     * Sets certificate_expiring
     *
     * @param bool|null $certificate_expiring Whether the destination certificate is in danger of expiring soon (within 30 days).
     *
     * @return self
     */
    public function setCertificateExpiring($certificate_expiring)
    {
        if (is_null($certificate_expiring)) {
            throw new \InvalidArgumentException('non-nullable certificate_expiring cannot be null');
        }
        $this->container['certificate_expiring'] = $certificate_expiring;
