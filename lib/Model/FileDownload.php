...
/**
 * FileDownload Class Doc Comment
 *
 * @category Class
 ...
 */
class FileDownload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FileDownload';
    ...
    */
     ...
     * Sets expires_at
     *
     * @param string $expires_at The expiration for the url.
     *
     * @return self
     */
