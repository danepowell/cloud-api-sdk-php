...
class Agreement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'created_at' => '\DateTime',
        'updated_at' => '\DateTime',
        'actioned_by' => '\Acquia\CloudApi\Model\UserStub',
        'reference' => '\Acquia\CloudApi\Model\AgreementReference',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('document_uuid', $data ?? [], null);
        $this->setIfExists('title', $data ?? [], null);
        $this->setIfExists('body', $data ?? [], null);
        $this->setIfExists('status', $data ?? [], null);
        $this->setIfExists('created_at', $data ?? [], null);
        $this->setIfExists('updated_at', $data ?? [], null);
        $this->setIfExists('actioned_by', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['document_uuid'] === null) {
            $invalidProperties[] = "'document_uuid' can't be null";
        }
        ...
        if ($this->container['actioned_by'] === null) {
            $invalidProperties[] = "'actioned_by' can't be null";
        }
     ...
     * Sets uuid
     *
     * @param string $uuid The agreement UUID.
     *
     * @return self
     */
     ...
     * Sets document_uuid
     *
     * @param string $document_uuid The agreement document UUID.
     *
     * @return self
     */
    public function setDocumentUuid($document_uuid)
    {
        if (is_null($document_uuid)) {
            throw new \InvalidArgumentException('non-nullable document_uuid cannot be null');
        }
     ...
     * Sets title
     *
     * @param string $title The name of the agreement.
     *
     * @return self
     */
     ...
     * Sets body
     *
     * @param string $body The formatted agreement content.
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at The date the agreement was created.
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime $updated_at The date the agreement was last updated.
     *
     * @return self
     */
     ...
     * Sets actioned_by
     *
     * @param \Acquia\CloudApi\Model\UserStub $actioned_by actioned_by
     *
     * @return self
     */
    public function setActionedBy($actioned_by)
    {
        if (is_null($actioned_by)) {
            throw new \InvalidArgumentException('non-nullable actioned_by cannot be null');
        }
     ...
     * Gets reference
     *
     * @return \Acquia\CloudApi\Model\AgreementReference
     */
     ...
     * Sets reference
     *
     * @param \Acquia\CloudApi\Model\AgreementReference $reference reference
     *
     * @return self
     */
