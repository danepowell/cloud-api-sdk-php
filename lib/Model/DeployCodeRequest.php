...
/**
 * DeployCodeRequest Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class DeployCodeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeployCodeRequest';
    ...
    */
     ...
     * Sets source
     *
     * @param string $source The ID of the environment to deploy code from.
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message An optional commit message to include when creating a new tag.
     *
     * @return self
     */
     ...
     * Sets cloud_actions
     *
     * @param string[]|null $cloud_actions An optional array of Cloud Actions.
     *
     * @return self
     */
