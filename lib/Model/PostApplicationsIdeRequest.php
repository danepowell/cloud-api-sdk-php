...
/**
 * PostApplicationsIdeRequest Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApplicationsIdeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postApplicationsIde_request';
    ...
    */
     ...
     * Sets label
     *
     * @param string $label The label of the Cloud IDE.
     *
     * @return self
     */
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) > 255)) {
            throw new \InvalidArgumentException('invalid length for $label when calling PostApplicationsIdeRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($label) < 1)) {
            throw new \InvalidArgumentException('invalid length for $label when calling PostApplicationsIdeRequest., must be bigger than or equal to 1.');
        }
