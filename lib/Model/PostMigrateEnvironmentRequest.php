...
/**
 * PostMigrateEnvironmentRequest Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class PostMigrateEnvironmentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postMigrateEnvironment_request';
    ...
    */
     ...
     * Sets label
     *
     * @param string $label The Migrate Environment label.
     *
     * @return self
     */
     ...
     * Sets config
     *
     * @param bool|null $config Indicates whether or not to copy configurations.
     *
     * @return self
     */
