...
/**
 * PostPromoteEnvironmentRequest Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class PostPromoteEnvironmentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postPromoteEnvironment_request';
    ...
    */
     ...
     * Sets target
     *
     * @param string $target The UUID of the environment to promote to.
     *
     * @return self
     */
