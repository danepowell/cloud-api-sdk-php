...
/**
 * PostDeployArtifactRequest Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class PostDeployArtifactRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postDeployArtifact_request';
    ...
    */
     ...
     * Sets artifact_id
     *
     * @param string $artifact_id The id of the artifact to deploy.
     *
     * @return self
     */
