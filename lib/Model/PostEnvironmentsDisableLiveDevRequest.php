<?php
/**
 * PostEnvironmentsDisableLiveDevRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostEnvironmentsDisableLiveDevRequest Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class PostEnvironmentsDisableLiveDevRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postEnvironmentsDisableLiveDev_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['discard']) && ($this->container['discard'] > 1)) {
            $invalidProperties[] = "invalid value for 'discard', must be smaller than or equal to 1.";
        }

        if (!is_null($this->container['discard']) && ($this->container['discard'] < 0)) {
            $invalidProperties[] = "invalid value for 'discard', must be bigger than or equal to 0.";
        }
     ...
     * Sets discard
     *
     * @param int|null $discard Indicates whether uncommitted changes should be discarded or not.
     *
     * @return self
     */
    public function setDiscard($discard)
    {
        ...
        if (($discard > 1)) {
            throw new \InvalidArgumentException('invalid value for $discard when calling PostEnvironmentsDisableLiveDevRequest., must be smaller than or equal to 1.');
        }
        if (($discard < 0)) {
            throw new \InvalidArgumentException('invalid value for $discard when calling PostEnvironmentsDisableLiveDevRequest., must be bigger than or equal to 0.');
        }
