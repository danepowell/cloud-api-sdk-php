<?php
/**
 * UserMetadataApplicationsRecentInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * UserMetadataApplicationsRecentInner Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class UserMetadataApplicationsRecentInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'User_metadata_applications_recent_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('recent_at', $data ?? [], null);
    }
    ...
    */
     ...
     */
    public function getRecentAt()
    {
        return $this->container['recent_at'];
    }

    /**
     * Sets recent_at
     *
     * @param \DateTime|null $recent_at The date-time when the application was accessed.
     *
     * @return self
     */
    public function setRecentAt($recent_at)
    {
        if (is_null($recent_at)) {
            throw new \InvalidArgumentException('non-nullable recent_at cannot be null');
        }
        $this->container['recent_at'] = $recent_at;
