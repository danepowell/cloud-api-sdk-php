...
class Health implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets code
     *
     * @param string|null $code The status code for the current health.
     *
     * @return self
     */
     ...
     * Sets details
     *
     * @param string|null $details Full details about the current health code.
     *
     * @return self
     */
     ...
     * Sets summary
     *
     * @param string|null $summary A brief summary that explains why the health code is present.
     *
     * @return self
     */
