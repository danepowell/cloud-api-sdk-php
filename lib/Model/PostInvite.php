 ...
 */
class PostInvite implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostInvite';
    ...
    */
     ...
     * Sets email
     *
     * @param string $email The email address of the user to invite to this team.
     *
     * @return self
     */
     ...
     * Sets roles
     *
     * @param string[] $roles The role UUIDs to grant to the invitee.
     *
     * @return self
     */
