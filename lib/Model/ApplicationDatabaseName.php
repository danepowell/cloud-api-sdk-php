...
/**
 * ApplicationDatabaseName Class Doc Comment
 *
 * @category Class
 ...
 */
class ApplicationDatabaseName implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplicationDatabaseName';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 63)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ApplicationDatabaseName., must be smaller than or equal to 63.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ApplicationDatabaseName., must be bigger than or equal to 1.');
        }
