<?php
/**
 * PostEnvironmentsDatabasesRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostEnvironmentsDatabasesRequest Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class PostEnvironmentsDatabasesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postEnvironmentsDatabases_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['source']) < 38)) {
            $invalidProperties[] = "invalid value for 'source', the character length must be bigger than or equal to 38.";
        }
     ...
     * Sets name
     *
     * @param string $name The name of the database to copy to the selected environment.
     *
     * @return self
     */
     ...
     * Sets source
     *
     * @param string $source The ID of the environment to copy the database from.
     *
     * @return self
     */
    public function setSource($source)
    {
        ...
        if ((mb_strlen($source) < 38)) {
            throw new \InvalidArgumentException('invalid length for $source when calling PostEnvironmentsDatabasesRequest., must be bigger than or equal to 38.');
        }
