 ...
 */
class DomainFlags implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DomainFlags';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['wildcard'] === null) {
            $invalidProperties[] = "'wildcard' can't be null";
        }
     ...
     * Sets default
     *
     * @param bool $default If the domain is the default domain of the environment.
     *
     * @return self
     */
     ...
     * Sets active
     *
     * @param bool $active If the domain is considered to be the main or active domain in this environment.
     *
     * @return self
     */
     ...
     * Sets wildcard
     *
     * @param bool $wildcard If this is a wildcard domain.
     *
     * @return self
     */
