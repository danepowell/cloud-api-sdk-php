    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling EnvironmentVariable., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling EnvironmentVariable., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^(?!(ACQUIA_|AH_))[A-Za-z_][A-Za-z0-9_]*$/", $name))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling EnvironmentVariable., must conform to the pattern /^(?!(ACQUIA_|AH_))[A-Za-z_][A-Za-z0-9_]*$/.");
        }
    ...
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) > 5000)) {
            throw new \InvalidArgumentException('invalid length for $value when calling EnvironmentVariable., must be smaller than or equal to 5000.');
        }
        if ((mb_strlen($value) < 0)) {
            throw new \InvalidArgumentException('invalid length for $value when calling EnvironmentVariable., must be bigger than or equal to 0.');
        }
