...
/**
 * DomainStatusFlags Class Doc Comment
 *
 * @category Class
 ...
 */
class DomainStatusFlags implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DomainStatusFlags';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('acquia_hosted', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets default
     *
     * @param bool|null $default Whether or not this is the default domain.
     *
     * @return self
     */
     ...
     * Sets active
     *
     * @param bool|null $active Whether or not this domain is active.
     *
     * @return self
     */
     ...
     * Sets dns_resolves
     *
     * @param bool|null $dns_resolves Whether or not this domain resolves in DNS.
     *
     * @return self
     */
     ...
     * @return bool|null
     */
    public function getAcquiaHosted()
    {
        return $this->container['acquia_hosted'];
    }

    /**
     * Sets acquia_hosted
     *
     * @param bool|null $acquia_hosted Whether or not this domain is Acquia-hosted.
     *
     * @return self
     */
    public function setAcquiaHosted($acquia_hosted)
    {
        if (is_null($acquia_hosted)) {
            throw new \InvalidArgumentException('non-nullable acquia_hosted cannot be null');
        }
        $this->container['acquia_hosted'] = $acquia_hosted;
