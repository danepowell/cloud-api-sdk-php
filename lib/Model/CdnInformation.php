...
/**
 * CdnInformation Class Doc Comment
 *
 * @category Class
 ...
 */
class CdnInformation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CdnInformation';
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status The current provisioning status of CDN for this domain.
     *
     * @return self
     */
