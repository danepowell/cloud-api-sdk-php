...
/**
 * PostOrganizationAvailableTagsRequestTagsInner Class Doc Comment
 *
 * @category Class
 ...
 */
class PostOrganizationAvailableTagsRequestTagsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postOrganizationAvailableTags_request_tags_inner';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 16)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PostOrganizationAvailableTagsRequestTagsInner., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($name) < 2)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PostOrganizationAvailableTagsRequestTagsInner., must be bigger than or equal to 2.');
        }
     ...
     * Sets color
     *
     * @param string $color The color name of the tag found via the GET /api/options/colors endpoint.
     *
     * @return self
     */
