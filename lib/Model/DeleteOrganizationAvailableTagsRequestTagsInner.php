...
/**
 * DeleteOrganizationAvailableTagsRequestTagsInner Class Doc Comment
 *
 * @category Class
 ...
 */
class DeleteOrganizationAvailableTagsRequestTagsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'deleteOrganizationAvailableTags_request_tags_inner';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 16)) {
            throw new \InvalidArgumentException('invalid length for $name when calling DeleteOrganizationAvailableTagsRequestTagsInner., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($name) < 2)) {
            throw new \InvalidArgumentException('invalid length for $name when calling DeleteOrganizationAvailableTagsRequestTagsInner., must be bigger than or equal to 2.');
        }
