<?php
/**
 * PostSubscriptionDomainRegistrationRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostSubscriptionDomainRegistrationRequest Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class PostSubscriptionDomainRegistrationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postSubscriptionDomainRegistration_request';
    ...
    */
     ...
     * Sets domain
     *
     * @param string|null $domain The domain name to add.
     *
     * @return self
     */
    public function setDomain($domain)
    {
        ...
        if ((mb_strlen($domain) > 253)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling PostSubscriptionDomainRegistrationRequest., must be smaller than or equal to 253.');
        }
        if ((mb_strlen($domain) < 3)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling PostSubscriptionDomainRegistrationRequest., must be bigger than or equal to 3.');
        }
