 ...
 */
class Vcs implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Vcs';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The type of VCS.
     *
     * @return self
     */
     ...
     * Sets path
     *
     * @param string $path The path or branch name.
     *
     * @return self
     */
