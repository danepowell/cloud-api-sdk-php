<?php
/**
 * PostChangeOrganizationOwnerRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostChangeOrganizationOwnerRequest Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class PostChangeOrganizationOwnerRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postChangeOrganizationOwner_request';
    ...
    */
     ...
     * Sets user_uuid
     *
     * @param string $user_uuid The uuid of the user you want to make the owner for this organization.
     *
     * @return self
     */
