...
/**
 * MessageWithLinks Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class MessageWithLinks implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MessageWithLinks';
    ...
    */
     ...
     * Sets message
     *
     * @param string $message The human-friendly confirmation of the creation of the resource.
     *
     * @return self
     */
