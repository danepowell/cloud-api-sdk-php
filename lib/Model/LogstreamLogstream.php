...
/**
 * LogstreamLogstream Class Doc Comment
 *
 * @category Class
 ...
 */
class LogstreamLogstream implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Logstream_logstream';
    ...
    */
     ...
     * Sets params
     *
     * @param object $params Connection details such as a timestamp, hmac, site name and environment.
     *
     * @return self
     */
     ...
     * Sets commands
     *
     * @param string[] $commands Commands for the logstream backend.
     *
     * @return self
     */
