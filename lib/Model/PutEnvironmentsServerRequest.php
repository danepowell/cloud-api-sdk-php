...
/**
 * PutEnvironmentsServerRequest Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class PutEnvironmentsServerRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'putEnvironmentsServer_request';
    ...
    {
        $this->setIfExists('memcache', $data ?? [], 64);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['memcache']) && ($this->container['memcache'] < 0)) {
            $invalidProperties[] = "invalid value for 'memcache', must be bigger than or equal to 0.";
        }
     ...
     * Sets memcache
     *
     * @param int|null $memcache The size (in MB) of memcache on this server.
     *
     * @return self
     */
    public function setMemcache($memcache)
    {
        ...
        if (($memcache < 0)) {
            throw new \InvalidArgumentException('invalid value for $memcache when calling PutEnvironmentsServerRequest., must be bigger than or equal to 0.');
        }
