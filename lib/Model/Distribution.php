...
class Distribution implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'urls' => '\Acquia\CloudApi\Model\DistributionUrls',
        'update_urls' => '\Acquia\CloudApi\Model\DistributionUpdateUrls',
        'title' => 'string',
        'version' => 'string',
        'drupal_version' => 'string',
        'description' => 'string',
        'image_url' => '\Acquia\CloudApi\Model\DistributionImageUrl',
        'flags' => '\Acquia\CloudApi\Model\DistributionFlags',
    ...
    protected static $setters = [
        'name' => 'setName',
        'urls' => 'setUrls',
        'update_urls' => 'setUpdateUrls',
        'title' => 'setTitle',
        'version' => 'setVersion',
        'drupal_version' => 'setDrupalVersion',
    ...
    protected static $getters = [
        'name' => 'getName',
        'urls' => 'getUrls',
        'update_urls' => 'getUpdateUrls',
        'title' => 'getTitle',
        'version' => 'getVersion',
        'drupal_version' => 'getDrupalVersion',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('update_urls', $data ?? [], null);
        $this->setIfExists('title', $data ?? [], null);
        $this->setIfExists('version', $data ?? [], null);
        $this->setIfExists('drupal_version', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['update_urls'] === null) {
            $invalidProperties[] = "'update_urls' can't be null";
        }
        ...
        if ($this->container['drupal_version'] === null) {
            $invalidProperties[] = "'drupal_version' can't be null";
        }
     ...
     * Gets urls
     *
     * @return \Acquia\CloudApi\Model\DistributionUrls
     */
     ...
     * Sets urls
     *
     * @param \Acquia\CloudApi\Model\DistributionUrls $urls urls
     *
     * @return self
     */
     ...
     * Gets update_urls
     *
     * @return \Acquia\CloudApi\Model\DistributionUpdateUrls
     */
    public function getUpdateUrls()
    {
        return $this->container['update_urls'];
    }

    /**
     * Sets update_urls
     *
     * @param \Acquia\CloudApi\Model\DistributionUpdateUrls $update_urls update_urls
     *
     * @return self
     */
    public function setUpdateUrls($update_urls)
    {
        if (is_null($update_urls)) {
            throw new \InvalidArgumentException('non-nullable update_urls cannot be null');
        }
        $this->container['update_urls'] = $update_urls;
     ...
     * Sets title
     *
     * @param string $title The title of the distribution.
     *
     * @return self
     */
     ...
     * Sets version
     *
     * @param string $version The full version string of the distribution.
     *
     * @return self
     */
    ...
    {
        return $this->container['drupal_version'];
    }

    /**
     * Sets drupal_version
     *
     * @param string $drupal_version The Drupal version string of the distribution.
     *
     * @return self
     */
    public function setDrupalVersion($drupal_version)
    {
        if (is_null($drupal_version)) {
            throw new \InvalidArgumentException('non-nullable drupal_version cannot be null');
        }
        $this->container['drupal_version'] = $drupal_version;
     ...
     * Sets description
     *
     * @param string $description The verbose description of the distribution.
     *
     * @return self
     */
     ...
     * Gets image_url
     *
     * @return \Acquia\CloudApi\Model\DistributionImageUrl
     */
     ...
     * Sets image_url
     *
     * @param \Acquia\CloudApi\Model\DistributionImageUrl $image_url image_url
     *
     * @return self
     */
     ...
     * Gets flags
     *
     * @return \Acquia\CloudApi\Model\DistributionFlags
     */
     ...
     * Sets flags
     *
     * @param \Acquia\CloudApi\Model\DistributionFlags $flags flags
     *
     * @return self
     */
