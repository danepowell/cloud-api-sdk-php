<?php
/**
 * ApplicationsPermissionsFlagsInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ApplicationsPermissionsFlagsInner Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class ApplicationsPermissionsFlagsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplicationsPermissions_flags_inner';
    ...
    */
     ...
     * Sets administrator
     *
     * @param bool $administrator Whether the current user is able to administrate the application.
     *
     * @return self
     */
