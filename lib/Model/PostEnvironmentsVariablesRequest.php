...
/**
 * PostEnvironmentsVariablesRequest Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class PostEnvironmentsVariablesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postEnvironmentsVariables_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['name']) && !preg_match("/^(?!(ACQUIA_|AH_))[A-Za-z_][A-Za-z0-9_]*$/", $this->container['name'])) {
            $invalidProperties[] = "invalid value for 'name', must be conform to the pattern /^(?!(ACQUIA_|AH_))[A-Za-z_][A-Za-z0-9_]*$/.";
        }
     ...
     * Sets name
     *
     * @param string|null $name The name of the environment variable to add.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PostEnvironmentsVariablesRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PostEnvironmentsVariablesRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^(?!(ACQUIA_|AH_))[A-Za-z_][A-Za-z0-9_]*$/", $name))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling PostEnvironmentsVariablesRequest., must conform to the pattern /^(?!(ACQUIA_|AH_))[A-Za-z_][A-Za-z0-9_]*$/.");
        }
     ...
     * Sets value
     *
     * @param string|null $value The value of the environment variable to add.
     *
     * @return self
     */
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) > 255)) {
            throw new \InvalidArgumentException('invalid length for $value when calling PostEnvironmentsVariablesRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($value) < 0)) {
            throw new \InvalidArgumentException('invalid length for $value when calling PostEnvironmentsVariablesRequest., must be bigger than or equal to 0.');
        }
