...
class TokenRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets label
     *
     * @param string $label The label to give to the token for future reference.
     *
     * @return self
     */
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) < 1)) {
            throw new \InvalidArgumentException('invalid length for $label when calling TokenRequest., must be bigger than or equal to 1.');
        }
