...
/**
 * PutCloudActions Class Doc Comment
 *
 * @category Class
 ...
 */
class PutCloudActions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PutCloudActions';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cloud_actions'] === null) {
            $invalidProperties[] = "'cloud_actions' can't be null";
        }
     ...
     * Sets cloud_actions
     *
     * @param array<string,bool> $cloud_actions cloud_actions
     *
     * @return self
     */
