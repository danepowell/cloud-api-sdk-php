...
/**
 * SubscriptionOrganization Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class SubscriptionOrganization implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Subscription_organization';
    ...
    */
     ...
     * Sets uuid
     *
     * @param string $uuid The organization's UUID.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name The human-readable organization name.
     *
     * @return self
     */
