 ...
 */
class RootStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Root_status';
    ...
    protected static $openAPITypes = [
        'configuration' => 'bool',
        'registry' => 'bool',
        'acp_provisioning_enabled' => 'bool',
        'acf_provisioning_enabled' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        'configuration' => null,
        'registry' => null,
        'acp_provisioning_enabled' => null,
        'acf_provisioning_enabled' => null
    ];
    ...
    protected static array $openAPINullables = [
        'configuration' => false,
		'registry' => false,
		'acp_provisioning_enabled' => false,
		'acf_provisioning_enabled' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'registry' => 'registry',
        'acp_provisioning_enabled' => 'acp_provisioning_enabled',
        'acf_provisioning_enabled' => 'acf_provisioning_enabled'
    ];
    ...
    protected static $setters = [
        ...
        'acp_provisioning_enabled' => 'setAcpProvisioningEnabled',
        'acf_provisioning_enabled' => 'setAcfProvisioningEnabled'
    ];
    ...
    protected static $getters = [
        ...
        'acp_provisioning_enabled' => 'getAcpProvisioningEnabled',
        'acf_provisioning_enabled' => 'getAcfProvisioningEnabled'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('acp_provisioning_enabled', $data ?? [], null);
        $this->setIfExists('acf_provisioning_enabled', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets configuration
     *
     * @param bool|null $configuration The current configuration system status.
     *
     * @return self
     */
     ...
     * Sets registry
     *
     * @param bool|null $registry The current registry system status.
     *
     * @return self
     */
    ...
    /**
     * Gets acp_provisioning_enabled
     *
     * @return bool|null
     */
    public function getAcpProvisioningEnabled()
    {
        return $this->container['acp_provisioning_enabled'];
    }

    /**
     * Sets acp_provisioning_enabled
     *
     * @param bool|null $acp_provisioning_enabled Whether Acquia Cloud Professional provisioning is currently enabled.
     *
     * @return self
     */
    public function setAcpProvisioningEnabled($acp_provisioning_enabled)
    {
        if (is_null($acp_provisioning_enabled)) {
            throw new \InvalidArgumentException('non-nullable acp_provisioning_enabled cannot be null');
        }
        $this->container['acp_provisioning_enabled'] = $acp_provisioning_enabled;

        return $this;
    }

    /**
     * Gets acf_provisioning_enabled
     *
     * @return bool|null
     */
    public function getAcfProvisioningEnabled()
    {
        return $this->container['acf_provisioning_enabled'];
    }

    /**
     * Sets acf_provisioning_enabled
     *
     * @param bool|null $acf_provisioning_enabled Whether Acquia Cloud Free provisioning is currently enabled.
     *
     * @return self
     */
    public function setAcfProvisioningEnabled($acf_provisioning_enabled)
    {
        if (is_null($acf_provisioning_enabled)) {
            throw new \InvalidArgumentException('non-nullable acf_provisioning_enabled cannot be null');
        }
        $this->container['acf_provisioning_enabled'] = $acf_provisioning_enabled;
