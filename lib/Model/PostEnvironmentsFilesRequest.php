...
/**
 * PostEnvironmentsFilesRequest Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class PostEnvironmentsFilesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postEnvironmentsFiles_request';
    ...
    */
     ...
     * Sets source
     *
     * @param string|null $source The ID of the environment to copy files from.
     *
     * @return self
     */
