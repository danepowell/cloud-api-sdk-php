...
/**
 * SubscriptionFlagsValue Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class SubscriptionFlagsValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionFlags_value';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('zuora', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets active
     *
     * @param bool|null $active If the subscription is active.
     *
     * @return self
     */
     ...
     * Sets expired
     *
     * @param bool|null $expired If the subscription is expired.
     *
     * @return self
     */
     ...
     * @return bool|null
     */
    public function getZuora()
    {
        return $this->container['zuora'];
    }

    /**
     * Sets zuora
     *
     * @param bool|null $zuora If the subscription is online paid.
     *
     * @return self
     */
    public function setZuora($zuora)
    {
        if (is_null($zuora)) {
            throw new \InvalidArgumentException('non-nullable zuora cannot be null');
        }
        $this->container['zuora'] = $zuora;
