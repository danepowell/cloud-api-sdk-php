...
class Pagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets total
     *
     * @param int|null $total The total number of objects in the collection.
     *
     * @return self
     */
     ...
     * Sets limit
     *
     * @param int|null $limit The limit on the number of objects in the collection.
     *
     * @return self
     */
     ...
     * Sets offset
     *
     * @param int|null $offset The offset on the retrieved objects in the collection.
     *
     * @return self
     */
