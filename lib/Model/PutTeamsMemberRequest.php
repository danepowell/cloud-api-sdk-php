...
/**
 * PutTeamsMemberRequest Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class PutTeamsMemberRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'putTeamsMember_request';
    ...
    */
     ...
     * Sets roles
     *
     * @param string[] $roles The role UUIDs to grant to the user.
     *
     * @return self
     */
