...
class Task implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'status' => 'string',
        'type' => 'string',
        'metadata' => '\Acquia\CloudApi\Model\TaskMetadataInner[]',
        'labels' => 'string[]',
    ...
    protected static $setters = [
        ...
        'labels' => 'setLabels',
        'reference_uuid' => 'setReferenceUuid',
        '_links' => 'setLinks'
    ];
    ...
    protected static $getters = [
        ...
        'labels' => 'getLabels',
        'reference_uuid' => 'getReferenceUuid',
        '_links' => 'getLinks'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('reference_uuid', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['reference_uuid'] === null) {
            $invalidProperties[] = "'reference_uuid' can't be null";
        }
     ...
     * Sets progress
     *
     * @param int $progress The progress of the event, from 0 to 100.
     *
     * @return self
     */
    public function setProgress($progress)
    {
        ...
        if (($progress > 100)) {
            throw new \InvalidArgumentException('invalid value for $progress when calling Task., must be smaller than or equal to 100.');
        }
        if (($progress < 0)) {
            throw new \InvalidArgumentException('invalid value for $progress when calling Task., must be bigger than or equal to 0.');
        }
     ...
     * Sets name
     *
     * @param string $name The machine name of the task.
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at The date that this task was created.
     *
     * @return self
     */
     ...
     * Sets started_at
     *
     * @param \DateTime $started_at The date that the task was started.
     *
     * @return self
     */
     ...
     * Sets completed_at
     *
     * @param \DateTime|null $completed_at The date that the task was completed.
     *
     * @return self
     */
     ...
     * Gets metadata
     *
     * @return \Acquia\CloudApi\Model\TaskMetadataInner[]
     */
     ...
     * Sets metadata
     *
     * @param \Acquia\CloudApi\Model\TaskMetadataInner[] $metadata Metadata for the task.
     *
     * @return self
     */
     ...
     * Sets labels
     *
     * @param string[] $labels Categorization labels associated with the task
     *
     * @return self
     */
    ...
    {
        return $this->container['reference_uuid'];
    }

    /**
     * Sets reference_uuid
     *
     * @param string $reference_uuid The UUID of the parent task. If there is no parent, this will be the task UUID.
     *
     * @return self
     */
    public function setReferenceUuid($reference_uuid)
    {
        if (is_null($reference_uuid)) {
            throw new \InvalidArgumentException('non-nullable reference_uuid cannot be null');
        }
        $this->container['reference_uuid'] = $reference_uuid;
