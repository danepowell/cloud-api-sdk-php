...
/**
 * DatabaseFlags Class Doc Comment
 *
 * @category Class
 ...
 */
class DatabaseFlags implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DatabaseFlags';
    ...
    protected static $setters = [
        'default' => 'setDefault',
        'perform_backup' => 'setPerformBackup'
    ];
    ...
    protected static $getters = [
        'default' => 'getDefault',
        'perform_backup' => 'getPerformBackup'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('perform_backup', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets default
     *
     * @param bool|null $default Whether this is the default database.
     *
     * @return self
     */
     ...
     * @return bool|null
     */
    public function getPerformBackup()
    {
        return $this->container['perform_backup'];
    }

    /**
     * Sets perform_backup
     *
     * @param bool|null $perform_backup Whether this database is backed up.
     *
     * @return self
     */
    public function setPerformBackup($perform_backup)
    {
        if (is_null($perform_backup)) {
            throw new \InvalidArgumentException('non-nullable perform_backup cannot be null');
        }
        $this->container['perform_backup'] = $perform_backup;
