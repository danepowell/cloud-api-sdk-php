 ...
 */
class PutCron implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PutCron';
    ...
    */
     ...
     * Sets frequency
     *
     * @param string|null $frequency The cron string that describes the frequency the cron will be run at.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label The label for this cron.
     *
     * @return self
     */
