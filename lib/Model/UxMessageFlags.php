...
/**
 * UxMessageFlags Class Doc Comment
 *
 * @category Class
 ...
 */
class UxMessageFlags implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UxMessageFlags';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('dismissible', $data ?? [], null);
    ...
    */
     ...
     * Sets dismissible
     *
     * @param bool|null $dismissible dismissible
     *
     * @return self
     */
    public function setDismissible($dismissible)
    {
        if (is_null($dismissible)) {
            throw new \InvalidArgumentException('non-nullable dismissible cannot be null');
        }
