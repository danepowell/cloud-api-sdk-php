...
class Certificate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'private_key' => 'string',
        'ca' => 'string',
        'flags' => 'array<string,\Acquia\CloudApi\Model\CertificateFlagsValue>',
        'expires_at' => '\DateTime',
        'domains' => 'string[]',
    ...
    */
     ...
     * Sets label
     *
     * @param string|null $label The certificate label (SNI only).
     *
     * @return self
     */
     ...
     * Sets certificate
     *
     * @param string $certificate Returns the PEM encoded certificate.
     *
     * @return self
     */
     ...
     * Sets ca
     *
     * @param string $ca The CA intermediary chain.
     *
     * @return self
     */
     ...
     * Gets flags
     *
     * @return array<string,\Acquia\CloudApi\Model\CertificateFlagsValue>
     */
     ...
     * Sets flags
     *
     * @param array<string,\Acquia\CloudApi\Model\CertificateFlagsValue> $flags An array of various flags that indicate functionality associated with the certificate.
     *
     * @return self
     */
     ...
     * Sets expires_at
     *
     * @param \DateTime $expires_at The ISO-8601 formatted date/time of the certificates expiration date.
     *
     * @return self
     */
     ...
     * Sets domains
     *
     * @param string[] $domains The domain names that this certificate is covering.
     *
     * @return self
     */
