...
/**
 * ApplicationHosting Class Doc Comment
 *
 * @category Class
 ...
 */
class ApplicationHosting implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Application_hosting';
    ...
    public const TYPE_ACE = 'ace';
    public const TYPE_ACP = 'acp';
    public const TYPE_ACSF = 'acsf';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type The hosting type.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id The hosting ID.
     *
     * @return self
     */
