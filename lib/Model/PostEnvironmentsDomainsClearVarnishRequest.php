<?php
/**
 * PostEnvironmentsDomainsClearVarnishRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostEnvironmentsDomainsClearVarnishRequest Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class PostEnvironmentsDomainsClearVarnishRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postEnvironmentsDomainsClearVarnish_request';
    ...
    */
     ...
     * Sets domains
     *
     * @param string[] $domains A list of domains to clear the Varnish cache for.
     *
     * @return self
     */
