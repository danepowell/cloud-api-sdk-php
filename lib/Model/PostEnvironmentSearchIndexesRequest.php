<?php
/**
 * PostEnvironmentSearchIndexesRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostEnvironmentSearchIndexesRequest Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class PostEnvironmentSearchIndexesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postEnvironmentSearchIndexes_request';
    ...
    */
     ...
     * Sets config_set_id
     *
     * @param string|null $config_set_id A configuration set ID to assign to the index.
     *
     * @return self
     */
     ...
     * Sets database_role
     *
     * @param string $database_role The database role for the search index.
     *
     * @return self
     */
