 ...
 */
class IsOwner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IsOwner';
    ...
    */
     ...
     * Sets owner
     *
     * @param bool $owner Whether or not the user account is an owner.
     *
     * @return self
     */
