...
class Backup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'database' => '\Acquia\CloudApi\Model\DatabaseStub',
        'type' => 'string',
        'started_at' => '\DateTime',
        'completed_at' => '\DateTime',
        'flags' => '\Acquia\CloudApi\Model\BackupFlags',
        'environment' => '\Acquia\CloudApi\Model\EnvironmentStub',
        '_links' => '\Acquia\CloudApi\Model\Links',
        '_embedded' => '\Acquia\CloudApi\Model\BackupEmbedded'
    ];
    ...
    */
     ...
     * Sets id
     *
     * @param int $id The ID of the database backup.
     *
     * @return self
     */
     ...
     * Gets database
     *
     * @return \Acquia\CloudApi\Model\DatabaseStub
     */
     ...
     * Sets database
     *
     * @param \Acquia\CloudApi\Model\DatabaseStub $database database
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type The type of backup this is.
     *
     * @return self
     */
     ...
     * Sets started_at
     *
     * @param \DateTime $started_at The ISO-8601 formatted date/time of when the backup process was started.
     *
     * @return self
     */
     ...
     * Sets completed_at
     *
     * @param \DateTime $completed_at The ISO-8601 formatted date/time of when the backup process was completed.
     *
     * @return self
     */
     ...
     * Gets flags
     *
     * @return \Acquia\CloudApi\Model\BackupFlags
     */
     ...
     * Sets flags
     *
     * @param \Acquia\CloudApi\Model\BackupFlags $flags flags
     *
     * @return self
     */
     ...
     * Gets _embedded
     *
     * @return \Acquia\CloudApi\Model\BackupEmbedded
     */
     ...
     * Sets _embedded
     *
     * @param \Acquia\CloudApi\Model\BackupEmbedded $_embedded _embedded
     *
     * @return self
     */
