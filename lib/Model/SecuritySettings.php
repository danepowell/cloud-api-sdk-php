...
/**
 * SecuritySettings Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class SecuritySettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SecuritySettings';
    ...
    */
     ...
     * Sets allowed_ips
     *
     * @param string[]|null $allowed_ips A list of IPs and CIDR values allowed to access an application. Set to null to disable whitelisting.
     *
     * @return self
     */
     ...
     * Sets tfa_required
     *
     * @param bool|null $tfa_required Whether TFA is required for an application.
     *
     * @return self
     */
