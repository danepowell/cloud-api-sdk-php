...
/**
 * PostEnvironmentsLogForwardingDestinationsRequestCredentials Class Doc Comment
 *
 * @category Class
 ...
 */
class PostEnvironmentsLogForwardingDestinationsRequestCredentials implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postEnvironmentsLogForwardingDestinations_request_credentials';
    ...
    */
     ...
     * Sets certificate
     *
     * @param string $certificate A public X.509 certificate in PEM format. Required for Splunk, Sumologic, and Syslog. Not supported by Loggly.
     *
     * @return self
     */
     ...
     * Sets key
     *
     * @param string|null $key A certificate private key associated with the consumer. Optional for Splunk, Sumologic, and Syslog.  Not supported by Loggly
     *
     * @return self
     */
     ...
     * Sets token
     *
     * @param string|null $token An API token associated with the consumer. Required by Logly and Sumologic. Optional for Syslog. Not supported by Splunk.
     *
     * @return self
     */
