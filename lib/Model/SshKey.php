    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['public_key']) < 64)) {
            $invalidProperties[] = "invalid value for 'public_key', the character length must be bigger than or equal to 64.";
        }
     ...
     * Sets uuid
     *
     * @param string $uuid The unique identifier of the SSH key.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string $label The human-readable key label.
     *
     * @return self
     */
    ...
    public function setPublicKey($public_key)
    {
        ...
        if ((mb_strlen($public_key) < 64)) {
            throw new \InvalidArgumentException('invalid length for $public_key when calling SshKey., must be bigger than or equal to 64.');
        }
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at The key creation date.
     *
     * @return self
     */
