...
class Logstream implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'logstream' => '\Acquia\CloudApi\Model\LogstreamLogstream',
    ...
    {
        $this->setIfExists('logstream', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['logstream'] === null) {
            $invalidProperties[] = "'logstream' can't be null";
        }
     ...
     * Gets logstream
     *
     * @return \Acquia\CloudApi\Model\LogstreamLogstream
     */
    public function getLogstream()
    {
        return $this->container['logstream'];
    }

    /**
     * Sets logstream
     *
     * @param \Acquia\CloudApi\Model\LogstreamLogstream $logstream logstream
     *
     * @return self
     */
    public function setLogstream($logstream)
    {
        if (is_null($logstream)) {
            throw new \InvalidArgumentException('non-nullable logstream cannot be null');
        }
        $this->container['logstream'] = $logstream;
