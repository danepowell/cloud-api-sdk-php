...
/**
 * ApplicationFeature Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class ApplicationFeature implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApplicationFeature';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name The feature flag machine name.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string $label The feature flag friendly name.
     *
     * @return self
     */
