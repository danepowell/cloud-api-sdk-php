...
/**
 * DistributionUpdateUrls Class Doc Comment
 *
 * @category Class
 ...
 */
class DistributionUpdateUrls implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Distribution_update_urls';
    ...
    protected static $openAPITypes = [
        'gz' => '\Acquia\CloudApi\Model\DistributionUpdateUrlsGz',
        'zip' => '\Acquia\CloudApi\Model\DistributionUpdateUrlsZip'
    ];
    ...
    */
     ...
     * Gets gz
     *
     * @return \Acquia\CloudApi\Model\DistributionUpdateUrlsGz|null
     */
    public function getGz()
    {
        return $this->container['gz'];
    }

    /**
     * Sets gz
     *
     * @param \Acquia\CloudApi\Model\DistributionUpdateUrlsGz|null $gz gz
     *
     * @return self
     */
    ...
    {
        if (is_null($gz)) {
            throw new \InvalidArgumentException('non-nullable gz cannot be null');
        }
        $this->container['gz'] = $gz;
     ...
     * Gets zip
     *
     * @return \Acquia\CloudApi\Model\DistributionUpdateUrlsZip|null
     */
     ...
     * Sets zip
     *
     * @param \Acquia\CloudApi\Model\DistributionUpdateUrlsZip|null $zip zip
     *
     * @return self
     */
