...
class Role implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'description' => 'string',
        'permissions' => '\Acquia\CloudApi\Model\Permission[]',
        'organization' => '\Acquia\CloudApi\Model\OrganizationStub',
        'last_edited' => '\Acquia\CloudApi\Model\RoleLastEdited',
        'flags' => '\Acquia\CloudApi\Model\RoleFlags'
    ];
    ...
    */
     ...
     * Sets uuid
     *
     * @param string|null $uuid The role unique identifier.
     *
     * @return self
     */
     ...
     * Gets permissions
     *
     * @return \Acquia\CloudApi\Model\Permission[]|null
     */
     ...
     * Sets permissions
     *
     * @param \Acquia\CloudApi\Model\Permission[]|null $permissions A collection of permissions a user with this role is granted.
     *
     * @return self
     */
     ...
     * Gets last_edited
     *
     * @return \Acquia\CloudApi\Model\RoleLastEdited|null
     */
     ...
     * Sets last_edited
     *
     * @param \Acquia\CloudApi\Model\RoleLastEdited|null $last_edited last_edited
     *
     * @return self
     */
    public function setLastEdited($last_edited)
    {
        if (is_null($last_edited)) {
            throw new \InvalidArgumentException('non-nullable last_edited cannot be null');
        }
     ...
     * Gets flags
     *
     * @return \Acquia\CloudApi\Model\RoleFlags|null
     */
     ...
     * Sets flags
     *
     * @param \Acquia\CloudApi\Model\RoleFlags|null $flags flags
     *
     * @return self
     */
