...
/**
 * DomainRegistrationDnsRecord Class Doc Comment
 *
 * @category Class
 ...
 */
class DomainRegistrationDnsRecord implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DomainRegistrationDnsRecord';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The name of the DNS record
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string $value The DNS record value.
     *
     * @return self
     */
