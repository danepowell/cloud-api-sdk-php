...
/**
 * PutRoleByUuidRequest Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class PutRoleByUuidRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'putRoleByUuid_request';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name The new name of the role.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PutRoleByUuidRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PutRoleByUuidRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets description
     *
     * @param string|null $description The new description of the role.
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PutRoleByUuidRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PutRoleByUuidRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets permissions
     *
     * @param string[]|null $permissions An array of the permissions associated with the role.
     *
     * @return self
     */
