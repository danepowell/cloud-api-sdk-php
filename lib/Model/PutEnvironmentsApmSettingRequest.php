...
/**
 * PutEnvironmentsApmSettingRequest Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class PutEnvironmentsApmSettingRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'putEnvironmentsApmSetting_request';
    ...
    public const TYPE_NEWRELIC = 'newrelic';
    ...
    */
     ...
     * Sets status
     *
     * @param bool|null $status Whether the APM tool should be enabled or disabled. If updating an existing install, this value does not need to be provided.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type The APM tool to install. Required if installing or updating a configuration.
     *
     * @return self
     */
     ...
     * Sets key
     *
     * @param string|null $key The key for the APM tool. Required if installing or updating a configuration. This value should be available from your APM provider.
     *
     * @return self
     */
