<?php
/**
 * PostApplicationEnvironmentsRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostApplicationEnvironmentsRequest Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class PostApplicationEnvironmentsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postApplicationEnvironments_request';
    ...
    */
     ...
     * Sets label
     *
     * @param string $label The new environment label.
     *
     * @return self
     */
     ...
     * Sets branch
     *
     * @param string $branch The name of the branch or tag that the continuous delivery environment will have.
     *
     * @return self
     */
     ...
     * Sets databases
     *
     * @param string[] $databases An array containing the names of the databases to add to the continuous delivery environment.
     *
     * @return self
     */
