...
class Artifact implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const STATE_PENDING_DELETE = 'pending-delete';
    public const STATE_PENDING_UPLOAD = 'pending-upload';
    public const STATE_READY = 'ready';
    public const STATE_UPLOAD_FAILED = 'upload-failed';
    ...
    public function getStateAllowableValues()
    {
        return [
            ...
            self::STATE_PENDING_UPLOAD,
            self::STATE_READY,
            self::STATE_UPLOAD_FAILED,
        ];
    }
    ...
    */
     ...
     * Sets id
     *
     * @param int $id The unique ID of the artifact.
     *
     * @return self
     */
     ...
     * Sets state
     *
     * @param string $state The state of the artifact.
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at The time at which the artifact was created.
     *
     * @return self
     */
