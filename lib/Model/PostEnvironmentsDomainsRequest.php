...
/**
 * PostEnvironmentsDomainsRequest Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class PostEnvironmentsDomainsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postEnvironmentsDomains_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['hostname']) && (mb_strlen($this->container['hostname']) < 3)) {
     ...
     * Sets hostname
     *
     * @param string|null $hostname The domain name to add.
     *
     * @return self
     */
    public function setHostname($hostname)
    {
        ...
        if ((mb_strlen($hostname) > 253)) {
            throw new \InvalidArgumentException('invalid length for $hostname when calling PostEnvironmentsDomainsRequest., must be smaller than or equal to 253.');
        }
        if ((mb_strlen($hostname) < 3)) {
            throw new \InvalidArgumentException('invalid length for $hostname when calling PostEnvironmentsDomainsRequest., must be bigger than or equal to 3.');
        }
