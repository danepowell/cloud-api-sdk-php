 ...
 */
class UserPhone implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'User_phone';
    ...
    */
     ...
     * Sets office
     *
     * @param string|null $office The office telephone number for the user.
     *
     * @return self
     */
     ...
     * Sets tfa
     *
     * @param string|null $tfa The tfa backup telephone number for the user.
     *
     * @return self
     */
