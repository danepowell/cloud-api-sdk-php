 ...
 */
class Cdn implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Cdn';
    ...
    */
     ...
     * Sets status
     *
     * @param string $status The CDN status.
     *
     * @return self
     */
