...
/**
 * SwitchCodeRequest Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class SwitchCodeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SwitchCodeRequest';
    ...
    */
     ...
     * Sets branch
     *
     * @param string $branch The name of the branch or tag to switch to.
     *
     * @return self
     */
