...
/**
 * LegacyProductKeysSettings Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class LegacyProductKeysSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LegacyProductKeysSettings';
    ...
    protected static $openAPITypes = [
        'acquia_connector' => '\Acquia\CloudApi\Model\LegacyProductKeysSettingsAcquiaConnector',
        'cloud_api' => '\Acquia\CloudApi\Model\LegacyProductKeysSettingsCloudApi',
    ...
    protected static $attributeMap = [
        'acquia_connector' => 'acquia_connector',
        'cloud_api' => 'cloud_api',
        '_links' => '_links'
    ];
    ...
    protected static $setters = [
        'acquia_connector' => 'setAcquiaConnector',
        'cloud_api' => 'setCloudApi',
        '_links' => 'setLinks'
    ];
    ...
    protected static $getters = [
        'acquia_connector' => 'getAcquiaConnector',
        'cloud_api' => 'getCloudApi',
        '_links' => 'getLinks'
    ];
    ...
    {
        $this->setIfExists('acquia_connector', $data ?? [], null);
        $this->setIfExists('cloud_api', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets acquia_connector
     *
     * @return \Acquia\CloudApi\Model\LegacyProductKeysSettingsAcquiaConnector|null
     */
    public function getAcquiaConnector()
    {
        return $this->container['acquia_connector'];
    }

    /**
     * Sets acquia_connector
     *
     * @param \Acquia\CloudApi\Model\LegacyProductKeysSettingsAcquiaConnector|null $acquia_connector acquia_connector
     *
     * @return self
     */
    public function setAcquiaConnector($acquia_connector)
    {
        if (is_null($acquia_connector)) {
            throw new \InvalidArgumentException('non-nullable acquia_connector cannot be null');
        }
        $this->container['acquia_connector'] = $acquia_connector;
     ...
     * Gets cloud_api
     *
     * @return \Acquia\CloudApi\Model\LegacyProductKeysSettingsCloudApi|null
     */
    public function getCloudApi()
    {
        return $this->container['cloud_api'];
    }

    /**
     * Sets cloud_api
     *
     * @param \Acquia\CloudApi\Model\LegacyProductKeysSettingsCloudApi|null $cloud_api cloud_api
     *
     * @return self
     */
    public function setCloudApi($cloud_api)
    {
        if (is_null($cloud_api)) {
            throw new \InvalidArgumentException('non-nullable cloud_api cannot be null');
        }
        $this->container['cloud_api'] = $cloud_api;
