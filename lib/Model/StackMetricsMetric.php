...
/**
 * StackMetricsMetric Class Doc Comment
 *
 * @category Class
 ...
 */
class StackMetricsMetric implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StackMetricsMetric';
    ...
    protected static $openAPITypes = [
        ...
        'metadata' => '\Acquia\CloudApi\Model\StackMetricsMetricMetadata'
    ];
    ...
    public const METRIC_APACHE_REQUESTS = 'apache-requests';
    public const METRIC_BAL_CPU = 'bal-cpu';
    public const METRIC_BAL_MEMORY = 'bal-memory';
    public const METRIC_CRON_MEMORY = 'cron-memory';
    public const METRIC_DB_CPU = 'db-cpu';
    public const METRIC_DB_DISK_SIZE = 'db-disk-size';
    public const METRIC_DB_DISK_USAGE = 'db-disk-usage';
    public const METRIC_DB_MEMORY = 'db-memory';
    public const METRIC_FILE_DISK_SIZE = 'file-disk-size';
    public const METRIC_FILE_CPU = 'file-cpu';
    public const METRIC_FILE_DISK_USAGE = 'file-disk-usage';
    public const METRIC_FILE_MEMORY = 'file-memory';
    public const METRIC_HTTP_2XX = 'http-2xx';
    public const METRIC_HTTP_3XX = 'http-3xx';
    public const METRIC_HTTP_4XX = 'http-4xx';
    public const METRIC_HTTP_5XX = 'http-5xx';
    public const METRIC_MYSQL_SLOW_QUERY_COUNT = 'mysql-slow-query-count';
    public const METRIC_NGINX_REQUESTS = 'nginx-requests';
    public const METRIC_OUT_OF_MEMORY = 'out-of-memory';
    public const METRIC_PHP_PROC_MAX_REACHED_SITE = 'php-proc-max-reached-site';
    public const METRIC_PHP_PROC_MAX_REACHED_TOTAL = 'php-proc-max-reached-total';
    public const METRIC_PHP_PROC_SITE = 'php-proc-site';
    public const METRIC_PHP_PROC_TOTAL = 'php-proc-total';
    public const METRIC_VARNISH_CACHE_HIT_RATE = 'varnish-cache-hit-rate';
    public const METRIC_VARNISH_REQUESTS = 'varnish-requests';
    public const METRIC_WEB_CPU = 'web-cpu';
    public const METRIC_WEB_MEMORY = 'web-memory';
    ...
    {
        return [
            self::METRIC_APACHE_REQUESTS,
            self::METRIC_BAL_CPU,
            self::METRIC_BAL_MEMORY,
            self::METRIC_CRON_MEMORY,
            self::METRIC_DB_CPU,
            self::METRIC_DB_DISK_SIZE,
            self::METRIC_DB_DISK_USAGE,
            self::METRIC_DB_MEMORY,
            self::METRIC_FILE_DISK_SIZE,
            self::METRIC_FILE_CPU,
            self::METRIC_FILE_DISK_USAGE,
            self::METRIC_FILE_MEMORY,
            self::METRIC_HTTP_2XX,
            self::METRIC_HTTP_3XX,
            self::METRIC_HTTP_4XX,
            self::METRIC_HTTP_5XX,
            self::METRIC_MYSQL_SLOW_QUERY_COUNT,
            self::METRIC_NGINX_REQUESTS,
            self::METRIC_OUT_OF_MEMORY,
            self::METRIC_PHP_PROC_MAX_REACHED_SITE,
            self::METRIC_PHP_PROC_MAX_REACHED_TOTAL,
            self::METRIC_PHP_PROC_SITE,
            self::METRIC_PHP_PROC_TOTAL,
            self::METRIC_VARNISH_CACHE_HIT_RATE,
            self::METRIC_VARNISH_REQUESTS,
            self::METRIC_WEB_CPU,
            self::METRIC_WEB_MEMORY,
        ];
    }
    ...
    */
     ...
     * Sets metric
     *
     * @param string $metric The name of the type of StackMetrics metric.
     *
     * @return self
     */
     ...
     * Sets datapoints
     *
     * @param string[][] $datapoints The data points for the StackMetrics request.
     *
     * @return self
     */
     ...
     * Sets last_data_at
     *
     * @param \DateTime $last_data_at The ISO-8601 date time when the last datapoint was sampled.
     *
     * @return self
     */
     ...
     * Gets metadata
     *
     * @return \Acquia\CloudApi\Model\StackMetricsMetricMetadata
     */
     ...
     * Sets metadata
     *
     * @param \Acquia\CloudApi\Model\StackMetricsMetricMetadata $metadata metadata
     *
     * @return self
     */
