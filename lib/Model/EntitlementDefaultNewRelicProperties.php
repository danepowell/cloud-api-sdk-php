<?php
/**
 * EntitlementDefaultNewRelicProperties
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * EntitlementDefaultNewRelicProperties Class Doc Comment
 *
 * @category Class
 ...
 */
class EntitlementDefaultNewRelicProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EntitlementDefaultNewRelic_properties';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The New Relic account identifier.
     *
     * @return self
     */
     ...
     * Sets level
     *
     * @param string|null $level The New Relic account level.
     *
     * @return self
     */
