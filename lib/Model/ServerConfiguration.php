...
class ServerConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('ecu', $data ?? [], null);
    ...
    */
     ...
     * Sets ecu
     *
     * @param int|null $ecu The number of EC2 Compute Units (ECU) for this server type.
     *
     * @return self
     */
    ...
    {
        if (is_null($ecu)) {
            throw new \InvalidArgumentException('non-nullable ecu cannot be null');
        }
     ...
     * Sets memory
     *
     * @param float|null $memory Returns the memory size (in GB) for this server type.
     *
     * @return self
     */
     ...
     * Sets memcache
     *
     * @param int|null $memcache Returns the memcache size (in MB) for this server (if it is a memcache server).
     *
     * @return self
     */
