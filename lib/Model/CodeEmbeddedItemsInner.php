...
/**
 * CodeEmbeddedItemsInner Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class CodeEmbeddedItemsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Code__embedded_items_inner';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'flags' => 'array<string,\Acquia\CloudApi\Model\CodeFlagsValue>'
    ];
    ...
    */
     ...
     * Sets name
     *
     * @param string $name The name of the branch or tag.
     *
     * @return self
     */
     ...
     * Gets flags
     *
     * @return array<string,\Acquia\CloudApi\Model\CodeFlagsValue>
     */
     ...
     * Sets flags
     *
     * @param array<string,\Acquia\CloudApi\Model\CodeFlagsValue> $flags An array of various flags that indicate functionality associated with code branches and tags on applications.
     *
     * @return self
     */
