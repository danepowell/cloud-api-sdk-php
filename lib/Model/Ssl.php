 ...
 */
class Ssl implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Ssl';
    ...
    */
     ...
     * Sets balancer
     *
     * @param string $balancer SSL configuration for the load balancer associated with this environment.
     *
     * @return self
     */
     ...
     * Sets ips
     *
     * @param string[] $ips The IP addresses for the environment.
     *
     * @return self
     */
