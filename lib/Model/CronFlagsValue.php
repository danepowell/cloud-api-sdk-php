...
/**
 * CronFlagsValue Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class CronFlagsValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CronFlags_value';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('on_any_web', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Whether this this cron is enabled.
     *
     * @return self
     */
     ...
     * Sets system
     *
     * @param bool|null $system Whether this is a system cron, which cannot be modified.
     *
     * @return self
     */
     ...
     * @return bool|null
     */
    public function getOnAnyWeb()
    {
        return $this->container['on_any_web'];
    }

    /**
     * Sets on_any_web
     *
     * @param bool|null $on_any_web Whether this cron will run on the lowest numbered web.
     *
     * @return self
     */
    public function setOnAnyWeb($on_any_web)
    {
        if (is_null($on_any_web)) {
            throw new \InvalidArgumentException('non-nullable on_any_web cannot be null');
        }
        $this->container['on_any_web'] = $on_any_web;
