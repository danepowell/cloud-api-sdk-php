...
class Token implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'label' => 'string',
        'revokation' => 'string',
        'flags' => '\Acquia\CloudApi\Model\TokenFlags',
        'created_at' => '\DateTime',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('revokation', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['revokation'] === null) {
            $invalidProperties[] = "'revokation' can't be null";
        }
     ...
     * Sets uuid
     *
     * @param string $uuid The token UUID.
     *
     * @return self
     */
     ...
     * Sets active
     *
     * @param bool $active Whether or not this token is active.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string $label The human-readable name for this token.
     *
     * @return self
     */
     ...
     * @return string
     */
    public function getRevokation()
    {
        return $this->container['revokation'];
    }

    /**
     * Sets revokation
     *
     * @param string $revokation If set, the reason why this token was revoked.
     *
     * @return self
     */
    public function setRevokation($revokation)
    {
        if (is_null($revokation)) {
            throw new \InvalidArgumentException('non-nullable revokation cannot be null');
        }
        $this->container['revokation'] = $revokation;
     ...
     * Gets flags
     *
     * @return \Acquia\CloudApi\Model\TokenFlags
     */
     ...
     * Sets flags
     *
     * @param \Acquia\CloudApi\Model\TokenFlags $flags flags
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at The creation date and time.
     *
     * @return self
     */
