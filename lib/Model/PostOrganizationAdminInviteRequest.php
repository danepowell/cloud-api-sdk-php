<?php
/**
 * PostOrganizationAdminInviteRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostOrganizationAdminInviteRequest Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class PostOrganizationAdminInviteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postOrganizationAdminInvite_request';
    ...
    */
     ...
     * Sets email
     *
     * @param string $email The email address of the user to invite as an administrator for this organization.
     *
     * @return self
     */
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $email when calling PostOrganizationAdminInviteRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling PostOrganizationAdminInviteRequest., must be bigger than or equal to 1.');
        }
