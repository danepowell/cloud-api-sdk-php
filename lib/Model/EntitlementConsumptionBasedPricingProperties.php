<?php
/**
 * EntitlementConsumptionBasedPricingProperties
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * EntitlementConsumptionBasedPricingProperties Class Doc Comment
 *
 * @category Class
 ...
 */
class EntitlementConsumptionBasedPricingProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EntitlementConsumptionBasedPricing_properties';
    ...
    */
     ...
     * Sets visits
     *
     * @param int|null $visits The maximum number of allowed unique visits.
     *
     * @return self
     */
     ...
     * Sets views
     *
     * @param int|null $views The maximum number of allowed views.
     *
     * @return self
     */
