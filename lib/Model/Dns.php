...
class Dns implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'apex_domain' => '\Acquia\CloudApi\Model\DnsRecord[]',
        'subdomains' => '\Acquia\CloudApi\Model\DnsRecord[]',
        'regional_configuration' => '\Acquia\CloudApi\Model\DnsRegionalConfiguration',
        'global_configuration' => '\Acquia\CloudApi\Model\DnsGlobalConfiguration',
    ...
    protected static $setters = [
        ...
        'regional_configuration' => 'setRegionalConfiguration',
        'global_configuration' => 'setGlobalConfiguration',
        '_links' => 'setLinks'
    ];
    ...
    protected static $getters = [
        ...
        'regional_configuration' => 'getRegionalConfiguration',
        'global_configuration' => 'getGlobalConfiguration',
        '_links' => 'getLinks'
    ];
    ...
    {
        $this->setIfExists('apex_domain', $data ?? [], null);
        $this->setIfExists('subdomains', $data ?? [], null);
        $this->setIfExists('regional_configuration', $data ?? [], null);
        $this->setIfExists('global_configuration', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['regional_configuration'] === null) {
            $invalidProperties[] = "'regional_configuration' can't be null";
        }
        if ($this->container['global_configuration'] === null) {
            $invalidProperties[] = "'global_configuration' can't be null";
        }
     ...
     * Gets apex_domain
     *
     * @return \Acquia\CloudApi\Model\DnsRecord[]
     * @deprecated
     */
     ...
     * Sets apex_domain
     *
     * @param \Acquia\CloudApi\Model\DnsRecord[] $apex_domain Environment apex domain DNS records.
     *
     * @return self
     * @deprecated
     */
    ...
    {
        if (is_null($apex_domain)) {
            throw new \InvalidArgumentException('non-nullable apex_domain cannot be null');
        }
     ...
     * Sets subdomains
     *
     * @param \Acquia\CloudApi\Model\DnsRecord[] $subdomains Environment subdomain DNS records.
     *
     * @return self
     * @deprecated
     */
    ...
    /**
     * Gets regional_configuration
     *
     * @return \Acquia\CloudApi\Model\DnsRegionalConfiguration
     */
    public function getRegionalConfiguration()
    {
        return $this->container['regional_configuration'];
    }

    /**
     * Sets regional_configuration
     *
     * @param \Acquia\CloudApi\Model\DnsRegionalConfiguration $regional_configuration regional_configuration
     *
     * @return self
     */
    public function setRegionalConfiguration($regional_configuration)
    {
        if (is_null($regional_configuration)) {
            throw new \InvalidArgumentException('non-nullable regional_configuration cannot be null');
        }
        $this->container['regional_configuration'] = $regional_configuration;

        return $this;
    }

    /**
     * Gets global_configuration
     *
     * @return \Acquia\CloudApi\Model\DnsGlobalConfiguration
     */
    public function getGlobalConfiguration()
    {
        return $this->container['global_configuration'];
    }

    /**
     * Sets global_configuration
     *
     * @param \Acquia\CloudApi\Model\DnsGlobalConfiguration $global_configuration global_configuration
     *
     * @return self
     */
    public function setGlobalConfiguration($global_configuration)
    {
        if (is_null($global_configuration)) {
            throw new \InvalidArgumentException('non-nullable global_configuration cannot be null');
        }
        $this->container['global_configuration'] = $global_configuration;
