...
/**
 * PostApplicationsTagsRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PostApplicationsTagsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postApplicationsTags_request';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name The label of the application tag.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 16)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PostApplicationsTagsRequest., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($name) < 2)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PostApplicationsTagsRequest., must be bigger than or equal to 2.');
        }
     ...
     * Sets color
     *
     * @param string $color The color name of the application tag found via the GET /api/options/colors endpoint.
     *
     * @return self
     */
