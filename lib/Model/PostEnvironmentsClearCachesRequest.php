<?php
/**
 * PostEnvironmentsClearCachesRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PostEnvironmentsClearCachesRequest Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class PostEnvironmentsClearCachesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postEnvironmentsClearCaches_request';
    ...
    */
     ...
     * Sets domains
     *
     * @param string[] $domains A list of domains to clear the caches for.
     *
     * @return self
     */
