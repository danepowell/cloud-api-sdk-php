...
/**
 * UxMessageFilters Class Doc Comment
 *
 * @category Class
 ...
 */
class UxMessageFilters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UxMessageFilters';
    ...
    public const DISPLAY_MODE_BAR = 'bar';
    public const DISPLAY_MODE__LIST = 'list';
    ...
    {
        return [
            self::DISPLAY_MODE_BAR,
            self::DISPLAY_MODE__LIST,
        ];
    }
    ...
    */
     ...
     * Sets paths
     *
     * @param string[]|null $paths Collection of paths.
     *
     * @return self
     */
     ...
     * Sets display_mode
     *
     * @param string|null $display_mode How the message should be displayed.
     *
     * @return self
     */
