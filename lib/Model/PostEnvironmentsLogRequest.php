...
/**
 * PostEnvironmentsLogRequest Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class PostEnvironmentsLogRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postEnvironmentsLog_request';
    ...
    */
     ...
     * Sets from
     *
     * @param string|null $from An ISO-8601 formatted date retrieve results from. Date ranges are only supported on Acquia Cloud Next.
     *
     * @return self
     */
     ...
     * Sets to
     *
     * @param string|null $to An ISO-8601 formatted date retrieve results to. Date ranges are only supported on Acquia Cloud Next.
     *
     * @return self
     */
