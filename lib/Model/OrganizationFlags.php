...
/**
 * OrganizationFlags Class Doc Comment
 *
 * @category Class
 ...
 */
class OrganizationFlags implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Organization_flags';
    ...
    protected static $setters = [
        'federated_authentication' => 'setFederatedAuthentication'
    ];
    ...
    protected static $getters = [
        'federated_authentication' => 'getFederatedAuthentication'
    ];
    ...
    {
        $this->setIfExists('federated_authentication', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets federated_authentication
     *
     * @return bool|null
     */
    public function getFederatedAuthentication()
    {
        return $this->container['federated_authentication'];
    }

    /**
     * Sets federated_authentication
     *
     * @param bool|null $federated_authentication Indicates whether the organization supports federated authentication.
     *
     * @return self
     */
    public function setFederatedAuthentication($federated_authentication)
    {
        if (is_null($federated_authentication)) {
            throw new \InvalidArgumentException('non-nullable federated_authentication cannot be null');
        }
        $this->container['federated_authentication'] = $federated_authentication;
