...
/**
 * PostTeamAddApplicationRequest Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class PostTeamAddApplicationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'postTeamAddApplication_request';
    ...
    */
     ...
     * Sets uuid
     *
     * @param string $uuid The uuid of the application to add to this team.
     *
     * @return self
     */
    public function setUuid($uuid)
    {
        ...
        if ((mb_strlen($uuid) > 36)) {
            throw new \InvalidArgumentException('invalid length for $uuid when calling PostTeamAddApplicationRequest., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($uuid) < 36)) {
            throw new \InvalidArgumentException('invalid length for $uuid when calling PostTeamAddApplicationRequest., must be bigger than or equal to 36.');
        }
