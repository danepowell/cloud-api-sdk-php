 ...
 */
class PostCron implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostCron';
    ...
    */
     ...
     * Sets frequency
     *
     * @param string $frequency The cron string that describes the frequency the cron will be run at.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string $label The label for this cron.
     *
     * @return self
     */
