...
/**
 * ImportSiteRequest Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class ImportSiteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImportSiteRequest';
    ...
    */
     ...
     * Sets url
     *
     * @param string $url The URL of the make file or tarball containing the site to import.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of the distribution being installed.
     *
     * @return self
     */
