...
/**
 * LogForwardingDestinationCredentials Class Doc Comment
 *
 * @category Class
 ...
 */
class LogForwardingDestinationCredentials implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LogForwardingDestinationCredentials';
    ...
    */
     ...
     * Sets key
     *
     * @param string $key The certificate private key, in PEM format, used to encrypt the log traffic. Optional for Splunk, Sumologic, and Syslog.  Not supported by Loggly
     *
     * @return self
     */
     ...
     * Sets expires_at
     *
     * @param \DateTime $expires_at The ISO-8601 date the certificate will expire at. Required by Logly and Sumologic. Optional for Syslog. Not supported by Splunk.
     *
     * @return self
     */
