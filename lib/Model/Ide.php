 ...
 */
class Ide implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Ide';
    ...
    protected static $openAPITypes = [
        ...
        '_embedded' => '\Acquia\CloudApi\Model\IdeEmbedded'
    ];
    ...
    public const STATUS_PROVISION_FAILED = 'provision-failed';
    ...
    */
     ...
     * Sets uuid
     *
     * @param string $uuid The unique identifier of the Cloud IDE.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string $label The human-friendly label of the Cloud IDE.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status The current provisioning status of the Cloud IDE.
     *
     * @return self
     */
     ...
     * Gets _embedded
     *
     * @return \Acquia\CloudApi\Model\IdeEmbedded|null
     */
     ...
     * Sets _embedded
     *
     * @param \Acquia\CloudApi\Model\IdeEmbedded|null $_embedded _embedded
     *
     * @return self
     */
