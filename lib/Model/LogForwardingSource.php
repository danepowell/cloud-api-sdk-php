...
/**
 * LogForwardingSource Class Doc Comment
 *
 * @category Class
 ...
 */
class LogForwardingSource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LogForwardingSource';
    ...
    */
     ...
     * Sets label
     *
     * @param string $label The source label.
     *
     * @return self
     */
     ...
     * Sets platforms
     *
     * @param string[] $platforms List of platforms for which the source is available.
     *
     * @return self
     */
