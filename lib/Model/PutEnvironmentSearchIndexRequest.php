<?php
/**
 * PutEnvironmentSearchIndexRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PutEnvironmentSearchIndexRequest Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class PutEnvironmentSearchIndexRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'putEnvironmentSearchIndex_request';
    ...
    */
     ...
     * Sets config_set_id
     *
     * @param string|null $config_set_id The configuration set ID to update to.
     *
     * @return self
     */
