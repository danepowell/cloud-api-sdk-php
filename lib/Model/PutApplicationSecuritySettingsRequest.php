<?php
/**
 * PutApplicationSecuritySettingsRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PutApplicationSecuritySettingsRequest Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class PutApplicationSecuritySettingsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'putApplicationSecuritySettings_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('tfa_required', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets allowed_ips
     *
     * @param string[]|null $allowed_ips The list of IPs to whitelist. Set to `null` to disable IP whitelisting.
     *
     * @return self
     */
     ...
     * @return bool|null
     */
    public function getTfaRequired()
    {
        return $this->container['tfa_required'];
    }

    /**
     * Sets tfa_required
     *
     * @param bool|null $tfa_required The configuration set to use.Whether TFA is required for application authentication.
     *
     * @return self
     */
    public function setTfaRequired($tfa_required)
    {
        if (is_null($tfa_required)) {
            throw new \InvalidArgumentException('non-nullable tfa_required cannot be null');
        }
        $this->container['tfa_required'] = $tfa_required;
