...
/**
 * PutIdentityProviderRequest Class Doc Comment
 *
 * @category Class
 * @package  Acquia\CloudApi
 * @author   OpenAPI Generator team
 ...
 */
class PutIdentityProviderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'putIdentityProvider_request';
    ...
    */
     ...
     * Sets label
     *
     * @param string|null $label The new identity provider label.
     *
     * @return self
     */
     ...
     * Sets entity_id
     *
     * @param string|null $entity_id The entity ID of the identity provider
     *
     * @return self
     */
     ...
     * Sets sso_url
     *
     * @param string|null $sso_url The URL of the SSO identity provider.
     *
     * @return self
     */
     ...
     * Sets certificate
     *
     * @param string|null $certificate The PEM-encoded X.509 certificate.
     *
     * @return self
     */
