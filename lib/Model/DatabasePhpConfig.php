...
/**
 * DatabasePhpConfig Class Doc Comment
 *
 * @category Class
 ...
 */
class DatabasePhpConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DatabasePhpConfig';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['drupal'] === null) {
            $invalidProperties[] = "'drupal' can't be null";
        }
     ...
     * Sets drupal
     *
     * @param string $drupal The Drupal PHP configuration settings file content.
     *
     * @return self
     */
