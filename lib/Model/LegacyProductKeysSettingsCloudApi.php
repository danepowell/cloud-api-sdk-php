<?php
/**
 * LegacyProductKeysSettingsCloudApi
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * LegacyProductKeysSettingsCloudApi Class Doc Comment
 *
 * @category Class
 ...
 */
class LegacyProductKeysSettingsCloudApi implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LegacyProductKeysSettings_cloud_api';
    ...
    */
     ...
     * Sets username
     *
     * @param string|null $username The Cloud API username (Subscription UUID).
     *
     * @return self
     */
     ...
     * Sets key
     *
     * @param string|null $key The Cloud API key.
     *
     * @return self
     */
