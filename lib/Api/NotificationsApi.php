...
/**
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getNotificationByUuid'] to see the possible values for this operation
     *
     ...
     */
    public function getNotificationByUuid($notification_uuid, string $contentType = self::contentTypes['getNotificationByUuid'][0])
    {
        list($response) = $this->getNotificationByUuidWithHttpInfo($notification_uuid, $contentType);
        return $response;
    }

    /**
     * Operation getNotificationByUuidWithHttpInfo
     *
     * Returns a single notification.
     *
     * @param  string $notification_uuid The entity&#39;s universally unique identifier. (required)
     ...
     */
    public function getNotificationByUuidWithHttpInfo($notification_uuid, string $contentType = self::contentTypes['getNotificationByUuid'][0])
    {
        $request = $this->getNotificationByUuidRequest($notification_uuid, $contentType);
    ...
    /**
     * Operation getNotificationByUuidAsync
     *
     * Returns a single notification.
     *
     * @param  string $notification_uuid The entity&#39;s universally unique identifier. (required)
     ...
     */
    public function getNotificationByUuidAsync($notification_uuid, string $contentType = self::contentTypes['getNotificationByUuid'][0])
    {
        return $this->getNotificationByUuidAsyncWithHttpInfo($notification_uuid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getNotificationByUuidAsyncWithHttpInfo
     *
     * Returns a single notification.
     *
     * @param  string $notification_uuid The entity&#39;s universally unique identifier. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getNotificationByUuidAsyncWithHttpInfo($notification_uuid, string $contentType = self::contentTypes['getNotificationByUuid'][0])
    {
        $returnType = '\Acquia\CloudApi\Model\Notification';
        $request = $this->getNotificationByUuidRequest($notification_uuid, $contentType);
    ...
    /**
     * Create request for operation 'getNotificationByUuid'
     *
     * @param  string $notification_uuid The entity&#39;s universally unique identifier. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getNotificationByUuid'] to see the possible values for this operation
     *
     ...
     */
    public function getNotificationByUuidRequest($notification_uuid, string $contentType = self::contentTypes['getNotificationByUuid'][0])
    {
        ...
        if ($notification_uuid === null || (is_array($notification_uuid) && count($notification_uuid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $notification_uuid when calling getNotificationByUuid'
            );
        }


        $resourcePath = '/notifications/{notificationUuid}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
