...
/**
     ...
     *
     * @param  string $ide_uuid The Cloud IDE universally unique identifier. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteIde'] to see the possible values for this operation
     *
     ...
     */
    public function deleteIde($ide_uuid, string $contentType = self::contentTypes['deleteIde'][0])
    {
        list($response) = $this->deleteIdeWithHttpInfo($ide_uuid, $contentType);
        return $response;
    }

    /**
     * Operation deleteIdeWithHttpInfo
     *
     * De-provisions a specific Cloud IDE.
     *
     * @param  string $ide_uuid The Cloud IDE universally unique identifier. (required)
     ...
     */
    public function deleteIdeWithHttpInfo($ide_uuid, string $contentType = self::contentTypes['deleteIde'][0])
    {
        $request = $this->deleteIdeRequest($ide_uuid, $contentType);
     ...
     */
    public function deleteIdeAsync($ide_uuid, string $contentType = self::contentTypes['deleteIde'][0])
    {
        return $this->deleteIdeAsyncWithHttpInfo($ide_uuid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteIdeAsyncWithHttpInfo
     *
     * De-provisions a specific Cloud IDE.
     *
     * @param  string $ide_uuid The Cloud IDE universally unique identifier. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteIdeAsyncWithHttpInfo($ide_uuid, string $contentType = self::contentTypes['deleteIde'][0])
    {
        $returnType = '\Acquia\CloudApi\Model\MessageWithLinks';
        $request = $this->deleteIdeRequest($ide_uuid, $contentType);
    ...
    /**
     * Create request for operation 'deleteIde'
     *
     * @param  string $ide_uuid The Cloud IDE universally unique identifier. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteIde'] to see the possible values for this operation
     *
     ...
     */
    public function deleteIdeRequest($ide_uuid, string $contentType = self::contentTypes['deleteIde'][0])
    {

        // verify the required parameter 'ide_uuid' is set
        if ($ide_uuid === null || (is_array($ide_uuid) && count($ide_uuid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ide_uuid when calling deleteIde'
            );
        }


        $resourcePath = '/ides/{ideUuid}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($ide_uuid !== null) {
            $resourcePath = str_replace(
                '{' . 'ideUuid' . '}',
                ObjectSerializer::toPathValue($ide_uuid),
                $resourcePath
            );
        }
     ...
     *
     * @param  string $ide_uuid The Cloud IDE universally unique identifier. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getIde'] to see the possible values for this operation
     *
     * @throws \Acquia\CloudApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Acquia\CloudApi\Model\Ide|\Acquia\CloudApi\Model\Error
     */
    public function getIde($ide_uuid, string $contentType = self::contentTypes['getIde'][0])
    {
        list($response) = $this->getIdeWithHttpInfo($ide_uuid, $contentType);
        return $response;
    }

    /**
     * Operation getIdeWithHttpInfo
     *
     * Returns Cloud IDE info.
     *
     * @param  string $ide_uuid The Cloud IDE universally unique identifier. (required)
     ...
     * @throws \Acquia\CloudApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Acquia\CloudApi\Model\Ide|\Acquia\CloudApi\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getIdeWithHttpInfo($ide_uuid, string $contentType = self::contentTypes['getIde'][0])
    {
        $request = $this->getIdeRequest($ide_uuid, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Acquia\CloudApi\Model\Ide' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Acquia\CloudApi\Model\Ide' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Acquia\CloudApi\Model\Ide', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\Acquia\CloudApi\Model\Ide';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getIdeAsync($ide_uuid, string $contentType = self::contentTypes['getIde'][0])
    {
        return $this->getIdeAsyncWithHttpInfo($ide_uuid, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getIdeAsyncWithHttpInfo
     *
     * Returns Cloud IDE info.
     *
     * @param  string $ide_uuid The Cloud IDE universally unique identifier. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getIdeAsyncWithHttpInfo($ide_uuid, string $contentType = self::contentTypes['getIde'][0])
    {
        $returnType = '\Acquia\CloudApi\Model\Ide';
        $request = $this->getIdeRequest($ide_uuid, $contentType);
    ...
    /**
     * Create request for operation 'getIde'
     *
     * @param  string $ide_uuid The Cloud IDE universally unique identifier. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getIde'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getIdeRequest($ide_uuid, string $contentType = self::contentTypes['getIde'][0])
    {

        // verify the required parameter 'ide_uuid' is set
        if ($ide_uuid === null || (is_array($ide_uuid) && count($ide_uuid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ide_uuid when calling getIde'
            );
        }
