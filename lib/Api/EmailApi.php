...
/**
     ...
     * @return \Acquia\CloudApi\Model\Email|\Acquia\CloudApi\Model\Error
     */
    public function getEmailStatus($environment_id, string $contentType = self::contentTypes['getEmailStatus'][0])
    {
        list($response) = $this->getEmailStatusWithHttpInfo($environment_id, $contentType);
        return $response;
    }
     ...
     * @throws \Acquia\CloudApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Acquia\CloudApi\Model\Email|\Acquia\CloudApi\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getEmailStatusWithHttpInfo($environment_id, string $contentType = self::contentTypes['getEmailStatus'][0])
    {
        $request = $this->getEmailStatusRequest($environment_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Acquia\CloudApi\Model\Email' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Acquia\CloudApi\Model\Email' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Acquia\CloudApi\Model\Email', []),
            ...
            $returnType = '\Acquia\CloudApi\Model\Email';
     ...
     */
    public function getEmailStatusAsync($environment_id, string $contentType = self::contentTypes['getEmailStatus'][0])
    {
        return $this->getEmailStatusAsyncWithHttpInfo($environment_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailStatusAsyncWithHttpInfo($environment_id, string $contentType = self::contentTypes['getEmailStatus'][0])
    {
        $returnType = '\Acquia\CloudApi\Model\Email';
        $request = $this->getEmailStatusRequest($environment_id, $contentType);
     ...
     */
    public function getEmailStatusRequest($environment_id, string $contentType = self::contentTypes['getEmailStatus'][0])
    {
        ...
        if ($environment_id === null || (is_array($environment_id) && count($environment_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $environment_id when calling getEmailStatus'
            );
        }


        $resourcePath = '/environments/{environmentId}/email';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
